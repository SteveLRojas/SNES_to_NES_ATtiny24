...
INIT:
	LDI DREG, 0b00010011
	OUT DDRA, DREG	;CONFIGURE PORT A
	LDI DREG, 0b00001000
	OUT DDRB, DREG	;CONFIGURE PORT B
	LDI DREG, 0b00000001
	OUT CLKPR, DREG	;SET CLOCK DIVIDER TO 2
	LDI DREG, 0b00110000
	OUT GIMSK, DREG	;DISABLE INT0, ENABLE PCIE1 AND PCIE0
	LDI DREG, 0b00000001
	OUT PCMSK1, DREG	;ENABLE PCINT8
	LDI DREG, 0b00000100
	OUT PCMSK0, DREG	;ENABLE PCINT2
	LDI DREG, 0b10000000
	OUT ACSR, DREG	;POWER OFF THE ANALOG COMPARATOR AND DISABLE THE INTERRUPT
	LDI NES_SHIFT, 0xFF	;CLEAR ALL BUTTONS
	SEI	;ENABLE INTERRUPTS
	RJMP MAIN

NES_OUT:
	SBIS PORTA, 2	;CHECK IF NES CLOCK IS HIGH
...
NES_LATCH:
	SBIS PORTB, 0	;CHECK IF NES LATCH IS HIGH
	RETI	;IF NOT THEN THIS WAS TRIGGERED BY A FALLING EDGE AND NOTHING NEEDS TO BE DONE
	CBI PORTA, 0
	SBRC NES, 0
